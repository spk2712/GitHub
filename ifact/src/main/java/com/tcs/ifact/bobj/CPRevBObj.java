...
public class CPRevBObj {
	
	private ArrayList<DPRevBObj> DPRevBObjList;
	...
	public void addDPRevBObj(DPRevBObj dpRevBObj) {
		if(null != getDPRevBObjList()) {
			getDPRevBObjList().add(dpRevBObj);
		}else {
			this.DPRevBObjList = new ArrayList<DPRevBObj>();
			getDPRevBObjList().add(dpRevBObj);
		}
	}

	public void removeDPRevBObj(DPRevBObj dpRevBObj) {
		if(null != getDPRevBObjList()) {
			getDPRevBObjList().remove(dpRevBObj);
		}
	}
	
	public ArrayList<DPRevBObj> getDPRevBObjList() {
		return DPRevBObjList;
	}
	public void setDPRevBObjList(ArrayList<DPRevBObj> dPRevBObjList) {
		DPRevBObjList = dPRevBObjList;
	}
