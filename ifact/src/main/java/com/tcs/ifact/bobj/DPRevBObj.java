...
public class DPRevBObj {
	
	private ArrayList<DMRevBObj> DMRevBObjList;
	
	private String DPName;

	private String Month1RevINR; 
	private String Month2RevINR; 
	private String Month3RevINR; 
	private String QuaterTotalRevINR;
	
	private String Month1Rev; 
	private String Month2Rev; 
	private String Month3Rev;
	private String QuaterTotalRev;
	...
	private String Month1MaxRevINR;
	private String Month2MaxRevINR;
	private String Month3MaxRevINR;
	private String QuaterTotalMaxRevINR;
	
	private String Month1MaxRev;
	private String Month2MaxRev;
	private String Month3MaxRev;
	private String QuaterTotalMaxRev;
	...
	public void addDMRevBObj(DMRevBObj dmRevBObj) {
		if(null != getDMRevBObjList()) {
			getDMRevBObjList().add(dmRevBObj);
		}else {
			this.DMRevBObjList = new ArrayList<DMRevBObj>();
			getDMRevBObjList().add(dmRevBObj);
		}
	}

	public void removeDMRevBObj(DMRevBObj dmRevBObj) {
		if(null != getDMRevBObjList()) {
			getDMRevBObjList().remove(dmRevBObj);
		}
	}
	
	public ArrayList<DMRevBObj> getDMRevBObjList() {
		return DMRevBObjList;
	}
	public void setDMRevBObjList(ArrayList<DMRevBObj> dMRevBObjList) {
		DMRevBObjList = dMRevBObjList;
	}
	public String getMonth1RevINR() {
		return Month1RevINR;
	}
	public void setMonth1RevINR(String month1RevINR) {
		Month1RevINR = month1RevINR;
	}
	public String getMonth2RevINR() {
		return Month2RevINR;
	}
	public void setMonth2RevINR(String month2RevINR) {
		Month2RevINR = month2RevINR;
	}
	public String getMonth3RevINR() {
		return Month3RevINR;
	}
	public void setMonth3RevINR(String month3RevINR) {
		Month3RevINR = month3RevINR;
	}
	public String getQuaterTotalRevINR() {
		return QuaterTotalRevINR;
	}
	public void setQuaterTotalRevINR(String quaterTotalRevINR) {
		QuaterTotalRevINR = quaterTotalRevINR;
	}
	public String getMonth1Rev() {
		return Month1Rev;
	}
	public void setMonth1Rev(String month1Rev) {
		Month1Rev = month1Rev;
	}
	public String getMonth2Rev() {
		return Month2Rev;
	}
	public void setMonth2Rev(String month2Rev) {
		Month2Rev = month2Rev;
	}
	public String getMonth3Rev() {
		return Month3Rev;
	}
	public void setMonth3Rev(String month3Rev) {
		Month3Rev = month3Rev;
	}
	public String getQuaterTotalRev() {
		return QuaterTotalRev;
	}
	public void setQuaterTotalRev(String quaterTotalRev) {
		QuaterTotalRev = quaterTotalRev;
	}
	public String getMonth1ActRevINR() {
		return Month1ActRevINR;
	}
	public void setMonth1ActRevINR(String month1ActRevINR) {
		Month1ActRevINR = month1ActRevINR;
	}
	public String getMonth2ActRevINR() {
		return Month2ActRevINR;
	}
	public void setMonth2ActRevINR(String month2ActRevINR) {
		Month2ActRevINR = month2ActRevINR;
	}
	public String getMonth3ActRevINR() {
		return Month3ActRevINR;
	}
	public void setMonth3ActRevINR(String month3ActRevINR) {
		Month3ActRevINR = month3ActRevINR;
	}
	public String getQuaterTotalActRevINR() {
		return QuaterTotalActRevINR;
	}
	public void setQuaterTotalActRevINR(String quaterTotalActRevINR) {
		QuaterTotalActRevINR = quaterTotalActRevINR;
	}
	public String getMonth1ActRev() {
		return Month1ActRev;
	}
	public void setMonth1ActRev(String month1ActRev) {
		Month1ActRev = month1ActRev;
	}
	public String getMonth2ActRev() {
		return Month2ActRev;
	}
	public void setMonth2ActRev(String month2ActRev) {
		Month2ActRev = month2ActRev;
	}
	public String getMonth3ActRev() {
		return Month3ActRev;
	}
	public void setMonth3ActRev(String month3ActRev) {
		Month3ActRev = month3ActRev;
	}
	public String getQuaterTotalActRev() {
		return QuaterTotalActRev;
	}
	public void setQuaterTotalActRev(String quaterTotalActRev) {
		QuaterTotalActRev = quaterTotalActRev;
	}
	public String getMonth1DiffRevINR() {
		return Month1DiffRevINR;
	}
	public void setMonth1DiffRevINR(String month1DiffRevINR) {
		Month1DiffRevINR = month1DiffRevINR;
	}
	public String getMonth2DiffRevINR() {
		return Month2DiffRevINR;
	}
	public void setMonth2DiffRevINR(String month2DiffRevINR) {
		Month2DiffRevINR = month2DiffRevINR;
	}
	public String getMonth3DiffRevINR() {
		return Month3DiffRevINR;
	}
	public void setMonth3DiffRevINR(String month3DiffRevINR) {
		Month3DiffRevINR = month3DiffRevINR;
	}
	public String getQuaterTotalDiffRevINR() {
		return QuaterTotalDiffRevINR;
	}
	public void setQuaterTotalDiffRevINR(String quaterTotalDiffRevINR) {
		QuaterTotalDiffRevINR = quaterTotalDiffRevINR;
	}
	public String getMonth1DiffRev() {
		return Month1DiffRev;
	}
	public void setMonth1DiffRev(String month1DiffRev) {
		Month1DiffRev = month1DiffRev;
	}
	public String getMonth2DiffRev() {
		return Month2DiffRev;
	}
	public void setMonth2DiffRev(String month2DiffRev) {
		Month2DiffRev = month2DiffRev;
	}
	public String getMonth3DiffRev() {
		return Month3DiffRev;
	}
	public void setMonth3DiffRev(String month3DiffRev) {
		Month3DiffRev = month3DiffRev;
	}
	public String getQuaterTotalDiffRev() {
		return QuaterTotalDiffRev;
	}
	public void setQuaterTotalDiffRev(String quaterTotalDiffRev) {
		QuaterTotalDiffRev = quaterTotalDiffRev;
	}
	public String getMonth1MaxRevINR() {
		return Month1MaxRevINR;
	}
	public void setMonth1MaxRevINR(String month1MaxRevINR) {
		Month1MaxRevINR = month1MaxRevINR;
	}
	public String getMonth2MaxRevINR() {
		return Month2MaxRevINR;
	}
	public void setMonth2MaxRevINR(String month2MaxRevINR) {
		Month2MaxRevINR = month2MaxRevINR;
	}
	public String getMonth3MaxRevINR() {
		return Month3MaxRevINR;
	}
	public void setMonth3MaxRevINR(String month3MaxRevINR) {
		Month3MaxRevINR = month3MaxRevINR;
	}
	public String getQuaterTotalMaxRevINR() {
		return QuaterTotalMaxRevINR;
	}
	public void setQuaterTotalMaxRevINR(String quaterTotalMaxRevINR) {
		QuaterTotalMaxRevINR = quaterTotalMaxRevINR;
	}
	public String getMonth1MaxRev() {
		return Month1MaxRev;
	}
	public void setMonth1MaxRev(String month1MaxRev) {
		Month1MaxRev = month1MaxRev;
	}
	public String getMonth2MaxRev() {
		return Month2MaxRev;
	}
	public void setMonth2MaxRev(String month2MaxRev) {
		Month2MaxRev = month2MaxRev;
	}
	public String getMonth3MaxRev() {
		return Month3MaxRev;
	}
	public void setMonth3MaxRev(String month3MaxRev) {
		Month3MaxRev = month3MaxRev;
	}
	public String getQuaterTotalMaxRev() {
		return QuaterTotalMaxRev;
	}
	public void setQuaterTotalMaxRev(String quaterTotalMaxRev) {
		QuaterTotalMaxRev = quaterTotalMaxRev;
	}
